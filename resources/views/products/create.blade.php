    ...
    <div class="max-w-2xl mx-auto p-6 bg-white shadow rounded">
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="checkbox" name="is_eco_friendly" id="is_eco_friendly" value="1" class="mt-1 rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            </div>
